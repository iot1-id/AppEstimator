...
function Estimate() {
  ...
  return (
    <div className="center">
      ...
      <hr className="style1" />
      <br />
      <h1 className="headings">3. Your Required Database</h1>
      <br />
      <CustomButton
        onClick={() => {
          if (isCloudBC) {
      ...
      <h1 className="headings">4. Number of Expected Users</h1>
      <br />
      <Col>
        <CustomButton
          onClick={() => {
      ...
      <hr className="style1" />
      <br />
      <h1 className="headings">5. Required Features</h1>
      <br />
      <Row>
      ...
      <hr className="style1" />
      <br />
      <h1 className="headings">6. Level of Customization</h1>
      <br />
      <Col>
        <Button
          id="ui1"
      ...
      <hr className="style1" />
      <br />
      <h1 className="headings">7. Required level of Security</h1>
      <br />
      <Col>
        <Button
          id="security1"
      ...
      {/* <Col className="ml-auto mr-auto" md="10" xl="6">
        ...
        <Card>
          <CardHeader>Estimations</CardHeader>
          <CardBody>
            <h4>Estimated times</h4>
            Minimum time: {minHours}, Maximum time: {maxHours}
